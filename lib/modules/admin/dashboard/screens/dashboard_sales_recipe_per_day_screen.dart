...
class DashboardSalesRecipePerDayScreen extends StatelessWidget {
  @override
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          Container(
                            margin: EdgeInsets.only(bottom: 6),
                            child: Text(
                              ModelAuth.permission == 99 || ModelAuth.permission == 1 ? NumberFormat.currency(locale: 'id', symbol: 'Rp. ', decimalDigits: 0).format(ModelDashboard.totalSalesRecipe) : NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format(ModelDashboard.totalInvSalesRecipe),
                              style: TextStyle(
                                color: ColorTheme.primary,
                                fontSize: 14,
