...
class DashboardSalesCreditPerDayScreen extends StatelessWidget {
  @override
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              ModelAuth.permission == 99 || ModelAuth.permission == 1 ? NumberFormat.currency(locale: 'id', symbol: 'Rp. ', decimalDigits: 0).format(ModelDashboard.totalSalesCredit) : NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format(ModelDashboard.totalInvSalesCredit),
                              style: TextStyle(
                                color: ColorTheme.primary,
                                fontSize: 14,
