...
class DashboardSalesRegularPerDayScreen extends StatelessWidget {
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          Container(
                            margin: EdgeInsets.only(bottom: 6),
                            child: Text(
                              ModelAuth.permission == 99 || ModelAuth.permission == 1 ? NumberFormat.currency(locale: 'id', symbol: 'Rp. ', decimalDigits: 0).format(ModelDashboard.totalSalesRegular) : NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format(ModelDashboard.totalInvSalesRegular),
                              style: TextStyle(
                                color: ColorTheme.primary,
                                fontSize: 14,
                                fontWeight: FontWeight.w600
