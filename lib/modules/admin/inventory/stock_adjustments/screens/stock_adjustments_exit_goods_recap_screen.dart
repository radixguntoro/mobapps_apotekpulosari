...
import 'package:apotik_pulosari/modules/admin/inventory/stock_adjustments/screens/stock_adjustments_exit_goods_create_screen.dart';
import 'package:apotik_pulosari/modules/admin/inventory/stock_adjustments/screens/stock_adjustments_exit_goods_recap_list_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:intl/intl.dart';
import 'package:mdi/mdi.dart';

class StockAdjustmentsExitGoodsRecapScreen extends StatefulWidget {
  @override
  _StockAdjustmentsExitGoodsRecapScreenState createState() => _StockAdjustmentsExitGoodsRecapScreenState();
}

class _StockAdjustmentsExitGoodsRecapScreenState extends State<StockAdjustmentsExitGoodsRecapScreen> {
  ...
  void initState() {
    super.initState();
    _stockAdjustmentsController.readFirst('exit_goods');
  ...
  void _onScroll() {
    ...
    if (maxScroll == currentScroll) {
      print(maxScroll);
      print(currentScroll);
      _stockAdjustmentsController.readMore('exit_goods');
    }
  }
    ...
    return Scaffold(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  onTap: () {
                                    ...
                                    // showSearch(context: context, delegate: StockAdjustmentsExitGoodsRecapSearchScreen());
                                  },
                                ),
                              ),
                            ),
                              ...
                              if(ModelStockAdjustments.getData.length > 0){
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, int i) {
                                    return i < ModelStockAdjustments.getData.length ? StockAdjustmentsExitGoodsRecapListScreen(ModelStockAdjustments.getData[i], i) : Container();
                                  },
                                );
                              } else {
      ...
      floatingActionButton: Container(
        ...
        child: FlatButton(
          ...
          onPressed: () async{
            Get.to(StockAdjustmentsExitGoodsCreateScreen(), transition: Transition.downToUp, duration: Duration(milliseconds: ModelTransition.speed),);
          },
        ),
        decoration: BoxDecoration(
