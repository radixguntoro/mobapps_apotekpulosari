...
import 'package:apotik_pulosari/modules/admin/transaction/return/screens/return_item_search_result_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:mdi/mdi.dart';

class ReturnItemSearchScreen extends SearchDelegate<String> {
    ...
    if(ModelItem.getData.length > 0) {
      return ListView.builder(
        ...
        itemBuilder: (context, int i) {
          return i < ModelItem.getData.length ? ReturnItemSearchResultScreen(ModelItem.getData[i], query, ModelItem.getData.length, i) : Container();
        },
      );
    } else {
