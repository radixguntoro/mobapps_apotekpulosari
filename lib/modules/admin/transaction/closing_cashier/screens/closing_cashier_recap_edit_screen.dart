    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: GetBuilder(
          ...
          builder: (resp) {
            if (ModelClosingCashier.isLoading == true) {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        margin: EdgeInsets.only(bottom: 8),
                        child: Text(
                          "Berikut ini data yang akan diubah",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 12,
                            color: Colors.black54
                          ...
                          text: TextSpan(
                            children: [
                              ...
                              WidgetSpan(
                                child: Container(
                                  child: Text(
                                    "${NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format(ModelClosingCashier.incomeReal)}",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      color: ColorTheme.primary,
                                      fontWeight: FontWeight.w600,
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: FlatButton(
                                ...
                                onPressed: () async {
                                  Get.close(null);
                                  _closingCashierController.updateData(data);
                                  _closingCashierController.readFirst();
                                  Get.off(ClosingCashierRecapScreen(), transition: Transition.downToUp, duration: Duration(milliseconds: ModelTransition.speed),);
                                },
                              ),
                            )
                          ],
