...
import 'package:apotik_pulosari/modules/admin/transaction/sales_lab/screens/sales_lab_recap_detail_screen.dart';
...
class SalesLabRecapSearchResultScreen extends StatelessWidget {
  final data;
  final query;
  final total;
  final index;

  SalesLabRecapSearchResultScreen(
    this.data,
    this.query,
    this.total,
    this.index,
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () {
                      Get.to(SalesLabRecapDetailScreen(data), transition: Transition.rightToLeft, duration: Duration(milliseconds: ModelTransition.speed),);
                    },
                  ),
                ),
              ],
