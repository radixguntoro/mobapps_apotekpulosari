...
import 'package:apotik_pulosari/modules/admin/transaction/sales_lab/screens/sales_lab_recap_checkup_info_screen.dart';
import 'package:apotik_pulosari/modules/admin/transaction/sales_lab/screens/sales_lab_recap_item_screen.dart';
...
class SalesLabRecapDetailScreen extends StatelessWidget {
  final SalesLabController _salesLabController = Get.put(SalesLabController());
  final data;

  SalesLabRecapDetailScreen(
    this.data
  );
  @override
                ...
                children: <Widget>[
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: FlatButton(
                                          ...
                                          onPressed: () => {
                                            Get.to(SalesLabRecapCheckUpInfoScreen(data), transition: Transition.downToUp, duration: Duration(milliseconds: ModelTransition.speed),)
                                          },
                                        )
                                      ),
                                    ],
                  ...
                  Container(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        "Total: ${NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((double.parse(data['tr_sales_lab_details'].length.toString())))} barang",
                        style: TextStyle(
                          fontSize: 12
                        ),
                      ),
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: ListView.builder(
                        padding: EdgeInsets.all(0),
                        itemCount: data['tr_sales_lab_details'].length > 0 ? data['tr_sales_lab_details'].length : 0,
                        itemBuilder: (context, int i) {
                          return data['tr_sales_lab_details'].length > 0 ? SalesLabRecapItemScreen(data['tr_sales_lab_details'][i], i) : Container();
                        },
                      ),
                    ),
                  ),
      ...
      floatingActionButton: Container(
        ...
        child: FlatButton(
          ...
          onPressed: () async{
            ...
            await _salesLabController.readDataById(data['tr_sales_transactions_id']);
