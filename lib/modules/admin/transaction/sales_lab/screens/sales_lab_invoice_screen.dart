...
import 'package:apotik_pulosari/modules/admin/transaction/sales_lab/screens/sales_lab_invoice_item_screen.dart';
...
class SalesLabInvoiceScreen extends StatelessWidget {
  final SalesLabController _salesLabController = Get.put(SalesLabController());
  final data;

  SalesLabInvoiceScreen(
    this.data
  );
  @override
    ...
    return Scaffold(
                            ...
                            child: Container(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, int index) {
                                  return data['details'].length > 0 ? SalesLabInvoiceItemScreen(data['details'][index]) : Container();
                                },
                              ),
                            ),
                          ),
      ...
      floatingActionButton: Container(
        ...
        child: FlatButton(
          ...
          onPressed: () async{
            _salesLabController.exportToPDF();
          },
        ),
        decoration: BoxDecoration(
