...
import 'package:apotik_pulosari/modules/admin/transaction/sales_lab/screens/sales_lab_cart_search_screen.dart';
import 'package:apotik_pulosari/modules/admin/transaction/sales_lab/screens/sales_lab_cart_item_screen.dart';
...
class SalesLabCartListScreen extends StatelessWidget {
  final SalesLabController _salesLabController = Get.put(SalesLabController());
  final TextEditingController _inpBarcode = TextEditingController(text: ModelSalesLab.barcode);
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  onTap: () {
                                    ...
                                    showSearch(context: context, delegate: SalesLabCartSearchScreen());
                                  },
                                ),
                              ),
                            ),
                            Container(
                              ...
                              child: FlatButton(
                                ...
                                onPressed: () async {
                                  ...
                                  _salesLabController.scanDataByBarcodeQRCode(tabletBarcode);
                                },
                              ),
                            ),
                          ],
                    ...
                    Expanded(
                      child: Container(
                        child: GetBuilder(
                          init: SalesLabController(),
                          builder: (resp) {
                            if(ModelSalesLab.getCart.length > 0) {
                              return ListView.builder(
                                shrinkWrap: true,
                                padding: EdgeInsets.all(0),
                                itemCount: ModelSalesLab.getCart.length > 0 ? ModelSalesLab.getCart.length : 0,
                                itemBuilder: (context, int i) {
                                  return ModelSalesLab.getCart.length > 0 ? SalesLabCartScreen(ModelSalesLab.getCart[i], i) : Container();
                                },
                              );
                            } else {
          ...
          child: Column(
            children: [
                        ...
                        children: [
                          GetBuilder(
                            ...
                            builder: (resp) {
                              return Container(
                                child: Text(
                                  NumberFormat.currency(locale: 'id', symbol: 'Rp. ', decimalDigits: 0).format((ModelSalesLab.total)),
                                  style: TextStyle(
              ...
              GetBuilder(
                init: SalesLabController(),
                builder: (resp) {
                  return ModelSalesLab.getCart.length > 0 ? _buttonEnable(context) : _buttonDisable(context);
                }
              ),
            ],
          ),
