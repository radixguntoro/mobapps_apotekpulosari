...
import 'package:apotik_pulosari/modules/admin/transaction/sales_regular/screens/sales_regular_recap_item_screen.dart';
...
class SalesRegularRecapDetailScreen extends StatelessWidget {
  final SalesRegularController _salesRegularController = Get.put(SalesRegularController());
  final data;

  SalesRegularRecapDetailScreen(
    this.data
  );
  @override
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        "Total: ${NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((double.parse(data['tr_sales_regular_details'].length.toString())))} barang",
                        style: TextStyle(
                          fontSize: 12
                        ),
                      ),
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: ListView.builder(
                        padding: EdgeInsets.all(0),
                        itemCount: data['tr_sales_regular_details'].length > 0 ? data['tr_sales_regular_details'].length : 0,
                        itemBuilder: (context, int index) {
                          return data['tr_sales_regular_details'].length > 0 ? SalesRegularRecapItemScreen(data['tr_sales_regular_details'][index], index) : Container();
                        },
                      ),
                    ),
                  ),
      ...
      floatingActionButton: Container(
        ...
        child: FlatButton(
          ...
          onPressed: () async{
            ...
            await _salesRegularController.readDataById(data['tr_sales_transactions_id']);
