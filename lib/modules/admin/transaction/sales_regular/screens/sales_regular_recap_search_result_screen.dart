...
import 'package:apotik_pulosari/modules/admin/transaction/sales_regular/screens/sales_regular_recap_detail_screen.dart';
...
class SalesRegularRecapSearchResultScreen extends StatelessWidget {
  final data;
  final query;
  final total;
  final index;

  SalesRegularRecapSearchResultScreen(
    this.data,
    this.query,
    this.total,
    this.index,
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () {
                      Get.to(SalesRegularRecapDetailScreen(data), transition: Transition.rightToLeft, duration: Duration(milliseconds: ModelTransition.speed),);
                    },
                  ),
                ),
              ],
