...
import 'package:apotik_pulosari/modules/admin/transaction/sales_regular/screens/sales_regular_recap_list_screen.dart';
import 'package:apotik_pulosari/modules/admin/transaction/sales_regular/screens/sales_regular_recap_search_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:intl/intl.dart';
import 'package:mdi/mdi.dart';

class SalesRegularRecapScreen extends StatefulWidget {
  @override
  _SalesRegularRecapScreenState createState() => _SalesRegularRecapScreenState();
}

class _SalesRegularRecapScreenState extends State<SalesRegularRecapScreen> {
  ...
  void _onScroll() {
    ...
    if (maxScroll == currentScroll) {
      print(maxScroll);
      print(currentScroll);
      _salesRegularController.readMore();
    }
  }
    ...
    return Scaffold(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: GetBuilder(
                        ...
                        builder: (_) {
                          return Text(
                            "Total: ${NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((ModelSalesRegular.totalData))} data",
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: GetBuilder(
                          init: SalesRegularController(),
                          builder: (resp) {
                            if (ModelSalesRegular.isLoading == true) {
                              ...
                              if(ModelSalesRegular.getData.length > 0){
                                return ListView.builder(
                                  shrinkWrap: true,
                                  padding: EdgeInsets.all(0),
                                  itemCount: ModelSalesRegular.maxData ? ModelSalesRegular.getData.length : ModelSalesRegular.getData.length + 1,
                                  controller: _scrollController,
                                  itemBuilder: (context, int i) {
                                    return i < ModelSalesRegular.getData.length ? SalesRegularRecapListScreen(ModelSalesRegular.getData[i], i) : Container();
                                  },
                                );
                              } else {
      ...
      floatingActionButton: Container(
        ...
        child: FlatButton(
          ...
          onPressed: () async{
            Get.to(SalesRegularCreateScreen(), transition: Transition.downToUp, duration: Duration(milliseconds: ModelTransition.speed),);
            _salesRegularController.calcTotal();
          },
        ),
        decoration: BoxDecoration(
