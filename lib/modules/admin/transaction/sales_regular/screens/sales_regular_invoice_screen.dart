...
import 'package:apotik_pulosari/modules/admin/transaction/sales_regular/screens/sales_regular_invoice_item_screen.dart';
    ...
    return Scaffold(
                              ...
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      TextTransform.title(data['userName']),
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                        fontSize: 12,
                                      ),
                            ...
                            child: Container(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, int index) {
                                  return data['details'].length > 0 ? SalesRegularInvoiceItemScreen(data['details'][index]) : Container();
                                },
                              ),
                            ),
                          ),
      ...
      floatingActionButton: Container(
        ...
        child: FlatButton(
          ...
          onPressed: () async{
            _salesRegularController.exportToPDF();
          },
        ),
        decoration: BoxDecoration(
