...
import 'package:apotik_pulosari/modules/admin/transaction/sales_mix/screens/sales_mix_invoice_item_screen.dart';
...
class SalesMixInvoiceScreen extends StatelessWidget {
  final SalesMixController _salesMixController = Get.put(SalesMixController());
  final data;

  SalesMixInvoiceScreen(
    this.data
  );
  @override
    ...
    return Scaffold(
                            ...
                            child: Container(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, int index) {
                                  return data['details'].length > 0 ? SalesMixInvoiceItemScreen(data['details'][index]) : Container();
                                },
                              ),
                            ),
                          ),
      ...
      floatingActionButton: Container(
        ...
        child: FlatButton(
          ...
          onPressed: () async{
            _salesMixController.exportToPDF();
          },
        ),
        decoration: BoxDecoration(
