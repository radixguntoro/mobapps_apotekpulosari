...
import 'package:apotik_pulosari/modules/admin/transaction/sales_mix/screens/sales_mix_recap_ingredients_list_screen.dart';
...
class SalesMixRecapItemScreen extends StatelessWidget {
  final item;
  final index;

  SalesMixRecapItemScreen(
    this.item,
    this.index,
  );
                                      ...
                                      WidgetSpan(
                                        child: Container(
                                          ...
                                          child: FlatButton(
                                            ...
                                            onPressed: () => {
                                              Get.to(SalesMixRecapIngredientsListScreen(item), transition: Transition.downToUp, duration: Duration(milliseconds: ModelTransition.speed),)
                                            },
                                          ),
                                        ),
                                      ),
