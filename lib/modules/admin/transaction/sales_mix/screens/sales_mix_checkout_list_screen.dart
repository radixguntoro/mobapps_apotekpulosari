...
import 'package:apotik_pulosari/modules/admin/transaction/sales_mix/screens/sales_mix_checkout_item_screen.dart';
...
class SalesMixCheckoutListScreen extends StatelessWidget {
                          ...
                          builder: (resp) {
                            return ListView.builder(
                              ...
                              itemBuilder: (context, int i) {
                                return ModelSalesMix.medicineMix.length > 0 ? SalesMixCheckoutItemScreen(ModelSalesMix.medicineMix[i], i) : Container();
                              },
                            );
                          },
                        ),
                                      ...
                                      Expanded(
                                        ...
                                        child: Container(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((ModelSalesMix.total)),
                                                style: TextStyle(
                                                  color: Colors.black,
                                                  fontSize: 14,
                                                  fontWeight: FontWeight.w600
                                      ...
                                      Expanded(
                                        ...
                                        child: Container(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((ModelSalesMix.discount)),
                                                style: TextStyle(
                                                  color: Colors.black54,
                                                  fontSize: 14,
                                                  fontWeight: FontWeight.w600
                                      ...
                                      Expanded(
                                        ...
                                        child: Container(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((ModelSalesMix.grandTotal)),
                                                style: TextStyle(
                                                  color: Colors.black,
                                                  fontSize: 14,
                                                  fontWeight: FontWeight.w600
                                      ...
                                      Expanded(
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((ModelSalesMix.payment)),
                                                style: TextStyle(
                                                  color: Colors.black54,
                                                  fontSize: 14,
                                                  fontWeight: FontWeight.w600
              ...
              child: Container(
                ...
                child: FlatButton(
                  ...
                  onPressed: () async {
                    ...
                    await _salesMixController.createData();
                    if (_.result == 'success') {
