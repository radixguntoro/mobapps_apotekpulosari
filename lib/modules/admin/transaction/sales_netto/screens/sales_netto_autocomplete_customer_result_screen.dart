...
class SalesNettoAutoCompleteCustomerResultScreen extends StatelessWidget {
  ...
  SalesNettoAutoCompleteCustomerResultScreen(
    this.item,
    this.query,
    this.index,
    this.state
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        _salesNettoController.setCustomer(item, state);
        Get.close(null);
      },
    );
  }
