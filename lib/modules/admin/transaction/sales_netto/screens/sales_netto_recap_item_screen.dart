...
import 'package:apotik_pulosari/modules/admin/transaction/sales_netto/screens/sales_netto_recap_return_form_screen.dart';
...
class SalesNettoRecapItemScreen extends StatelessWidget {
  final item;
  final data;
  final index;

  SalesNettoRecapItemScreen(
    this.item,
    this.data,
    this.index,
  );
      ...
      secondaryActions: showBtnReturn == 'show_all' ? [
        ...
        Container(
          ...
          child: FlatButton(
            ...
            onPressed: () async {
              Get.off(SalesNettoRecapReturnFormScreen(item, data), transition: Transition.downToUp, duration: Duration(milliseconds: ModelTransition.speed),);
            },
          ),
        ),
      ] : showBtnReturn == 'show_create' ? [
