...
class SalesNettoStockAdjustmentsCorrectScreen extends StatelessWidget {
  final SalesNettoController _salesNettoController = Get.put(SalesNettoController());
  final item;
  final data;

  SalesNettoStockAdjustmentsCorrectScreen(
    this.item,
    this.data,
  );
  @override
                                    ...
                                    Expanded(
                                      ...
                                      child: Container(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format(ModelSalesNetto.qtyAdjustments),
                                              style: TextStyle(
                                                color: Colors.black54,
                                                fontSize: 14,
                                                fontWeight: FontWeight.w600
                                    ...
                                    Expanded(
                                      ...
                                      child: Container(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format(ModelSalesNetto.qtyAdjustmentsDifference),
                                              style: TextStyle(
                                                color: ModelSalesNetto.qtyAdjustmentsDifference > 0 ? ColorTheme.primary : ColorTheme.danger,
                                                fontSize: 14,
                                                fontWeight: FontWeight.w600
                                              ),
                                            ),
    ...
    return Container(
      ...
      child: Container(
        ...
        child: FlatButton(
          ...
          onPressed: () async {
            _salesNettoController.createAdjustments(data, item);
            Get.close(null);
          },
        ),
      ),
