...
import 'package:apotik_pulosari/modules/admin/transaction/sales_netto/screens/sales_netto_autocomplete_customer_result_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:mdi/mdi.dart';

class SalesNettoAutoCompleteCustomerScreen extends SearchDelegate<String> {
  final CustomerController _customerController = Get.put(CustomerController());
  final state;

  SalesNettoAutoCompleteCustomerScreen(
    this.state
  );
    ...
    if(ModelCustomer.getData.length > 0) {
      return ListView.builder(
        ...
        itemBuilder: (context, int i) {
          return i < ModelCustomer.getData.length ? SalesNettoAutoCompleteCustomerResultScreen(ModelCustomer.getData[i], query, i, state) : Container();
        }
      );
    } else {
