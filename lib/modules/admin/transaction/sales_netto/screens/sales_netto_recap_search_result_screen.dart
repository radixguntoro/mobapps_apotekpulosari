...
class SalesNettoRecapSearchResultScreen extends StatelessWidget {
  final data;
  final query;
  final total;
  final index;

  SalesNettoRecapSearchResultScreen(
    this.data,
    this.query,
    this.total,
    this.index,
      ...
      secondaryActions: data['status'] != 'paid' ? <Widget>[
        Container(
          ...
          child: FlatButton(
            ...
            onPressed: () async {
              Get.off(SalesNettoRecapRepaymentScreen(data), transition: Transition.downToUp, duration: Duration(milliseconds: ModelTransition.speed),);
            },
          ),
        ),
      ] : [],
