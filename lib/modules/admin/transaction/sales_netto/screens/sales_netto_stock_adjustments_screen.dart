...
import 'package:apotik_pulosari/modules/admin/transaction/sales_netto/screens/sales_netto_stock_adjustments_item_screen.dart';
...
class SalesNettoStockAdjustmentsScreen extends StatelessWidget {
  final data;

  SalesNettoStockAdjustmentsScreen(
    this.data
  );
  @override
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, int index) {
                          return data['tr_sales_netto_details'].length > 0 ? SalesNettoStockAdjustmentsItemScreen(data['tr_sales_netto_details'][index], data, index) : Container();
                        },
                      ),
                    ),
                  ),
