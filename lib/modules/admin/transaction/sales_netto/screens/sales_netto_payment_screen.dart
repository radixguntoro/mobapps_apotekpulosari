...
import 'package:apotik_pulosari/modules/admin/transaction/sales_netto/screens/sales_netto_checkout_list_screen.dart';
...
class SalesNettoPaymentScreen extends StatelessWidget {
  final SalesNettoController _salesNettoController = Get.put(SalesNettoController());
  TextEditingController _valDiscount = TextEditingController(text: NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 2).format(ModelSalesNetto.discount));
  final _paymentStatus = ModelSalesNetto.getPaymentStatus;

  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        Get.off(SalesNettoCreateScreen(), transition: Transition.downToUp, duration: Duration(milliseconds: ModelTransition.speed),);
        _salesNettoController.clearPayment();
        return true;
      },
      child: Scaffold(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Container(
                                                  child: TextFormField(
                                                    controller: TextEditingController(text: TextTransform.title(ModelSalesNetto.customerPersonsName)),
                                                    readOnly: true,
                                                    ...
                                                    onTap: () {
                                                      ...
                                                      showSearch(context: context, delegate: SalesNettoAutoCompleteCustomerScreen('payment'));
                                                    },
                                                  ),
                                                ),
                                              ),
                                              Container(
                                                ...
                                                child: FlatButton(
                                                  ...
                                                  onPressed: () {
                                                    _salesNettoController.setClearCustomer();
                                                  },
                                                ),
                                              )
                                            ],
                                            ...
                                            children: [
                                              Container(
                                                child: TextFormField(
                                                  ...
                                                  controller: TextEditingController(text: NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 2).format(ModelSalesNetto.total)),
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                child: TextFormField(
                                                  ...
                                                  onChanged: (val) {
                                                    _salesNettoController.calcDiscount(val);
                                                    if (val.length < 1 || double.parse((val.replaceAll('.','')).replaceAll(',','.')) > ModelSalesNetto.total) {
                                                      _valDiscount = TextEditingController(text: NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 2).format(ModelSalesNetto.discount));
                                                    }
                                                  },
                                                ),
                                              )
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          child: TextFormField(
                                            enabled: false,
                                            keyboardType: TextInputType.number,
                                            controller: TextEditingController(text: NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 2).format(ModelSalesNetto.grandTotal)),
                                            textAlign: TextAlign.right,
                                            decoration: InputDecoration(
                                              floatingLabelBehavior: FloatingLabelBehavior.always,
                                              hintText: "0",
                                              ...
                                              return InputDecorator(
                                                ...
                                                child: DropdownButtonHideUnderline(
                                                  child: DropdownButton(
                                                    ...
                                                    value: ModelSalesNetto.paymentStatus,
                                                    isExpanded: true,
                                                    underline: Container(
                                                    ...
                                                    onChanged: (val) {
                                                      print(val);
                                                      _salesNettoController.setPaymentStatus(val);
                                                    },
                                                  ),
                                                ),
                                              );
          ...
          child: Column(
            children: [
              ...
              GetBuilder(
                init: SalesNettoController(),
                builder: (resp) {
                  return ModelSalesNetto.customerPersonsId != 'empty' ? _buttonEnable(context) : _buttonDisable(context);
                }
              ),
            ],
          ),
    ...
    return Container(
      ...
      child: Container(
        ...
        child: FlatButton(
          ...
          onPressed: () async {
            Get.off(SalesNettoCheckoutListScreen(), transition: Transition.downToUp, duration: Duration(milliseconds: ModelTransition.speed),);
          },
        ),
      ),
    );
