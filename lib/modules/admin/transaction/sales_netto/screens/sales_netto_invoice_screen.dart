...
import 'package:apotik_pulosari/modules/admin/transaction/sales_netto/screens/sales_netto_invoice_item_screen.dart';
    ...
    return Scaffold(
                            ...
                            child: Container(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, int index) {
                                  return data['details'].length > 0 ? SalesNettoInvoiceItemScreen(data['details'][index]) : Container();
                                },
                              ),
                            ),
                          ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                  flex: 4,
                                  child: Text(
                                    NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 2).format(double.parse(data['grandTotal'].toString())),
                                    textAlign: TextAlign.end,
                                    style: TextStyle(
                                      fontSize: 12
                                    ),
      ...
      floatingActionButton: Container(
        ...
        child: FlatButton(
          ...
          onPressed: () async{
            _salesNettoController.exportToPDF();
          },
        ),
        decoration: BoxDecoration(
