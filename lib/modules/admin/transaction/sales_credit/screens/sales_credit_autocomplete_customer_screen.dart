...
import 'package:apotik_pulosari/modules/admin/transaction/sales_credit/screens/sales_credit_autocomplete_customer_result_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:mdi/mdi.dart';

class SalesCreditAutoCompleteCustomerScreen extends SearchDelegate<String> {
    ...
    if(ModelCustomer.getData.length > 0) {
      return ListView.builder(
        ...
        itemBuilder: (context, int i) {
          return i < ModelCustomer.getData.length ? SalesCreditAutoCompleteCustomerResultScreen(ModelCustomer.getData[i], query, i) : Container();
        }
      );
    } else {
