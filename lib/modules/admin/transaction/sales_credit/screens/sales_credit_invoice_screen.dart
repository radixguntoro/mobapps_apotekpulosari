...
import 'package:apotik_pulosari/modules/admin/transaction/sales_credit/screens/sales_credit_invoice_item_screen.dart';
    ...
    return Scaffold(
                            ...
                            child: Container(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, int index) {
                                  return data['details'].length > 0 ? SalesCreditInvoiceItemScreen(data['details'][index]) : Container();
                                },
                              ),
                            ),
                          ),
      ...
      floatingActionButton: Container(
        ...
        child: FlatButton(
          ...
          onPressed: () async{
            _salesCreditController.exportToPDF();
          },
        ),
        decoration: BoxDecoration(
