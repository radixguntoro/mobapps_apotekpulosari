...
import 'package:apotik_pulosari/modules/admin/transaction/sales_credit/screens/sales_credit_checkout_item_screen.dart';
...
class SalesCreditCheckoutListScreen extends StatelessWidget {
                              ...
                              child: Container(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      child: Text(
                                        TextTransform.title(ModelSalesCredit.customerPersonsName),
                                        style: TextStyle(
                                          fontSize: 16,
                                          color: Colors.white,
                            ...
                            builder: (resp) {
                              return ListView.builder(
                                ...
                                itemBuilder: (context, int i) {
                                  return ModelSalesCredit.getCart.length > 0 ? SalesCreditCheckoutItemScreen(ModelSalesCredit.getCart[i], i) : Container();
                                },
                              );
                            },
                          ),
                                        ...
                                        Expanded(
                                          ...
                                          child: Container(
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((ModelSalesCredit.total)),
                                                  style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: 14,
                                                    fontWeight: FontWeight.w600
                                        ...
                                        Expanded(
                                          ...
                                          child: Container(
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((ModelSalesCredit.discount)),
                                                  style: TextStyle(
                                                    color: Colors.black54,
                                                    fontSize: 14,
                                                    fontWeight: FontWeight.w600
                ...
                child: Container(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () async {
                      ...
                      await _salesCreditController.createData();
                      if (_.result == 'success') {
