...
class SalesCreditRecapRepaymentScreen extends StatelessWidget {
  final SalesCreditController _salesCreditController = Get.put(SalesCreditController());
  final data;

  SalesCreditRecapRepaymentScreen(
    this.data,
  );
                                          ...
                                          child: GetBuilder(
                                            ...
                                            builder: (_) {
                                              return TextFormField(
                                                controller: TextEditingController(text: tanggal(ModelSalesCredit.customerRepaymentDate, shortMonth: true)),
                                                readOnly: true,
                                                ...
                                                onTap: () async {
                                                  ...
                                                  _salesCreditController.setRepaymentDate(_date);
                                                },
                                              );
                                            },
                                          ),
          ...
          if (ModelSalesCredit.isLoading == true) {
            ...
            return Container(
              ...
              child: FlatButton(
                ...
                onPressed: () async{
                  Get.close(null);
                  _salesCreditController.createRepayment(data);
                  // ignore: await_only_futures
                  await _salesCreditController.readFirst();
                },
              ),
            );
          }
