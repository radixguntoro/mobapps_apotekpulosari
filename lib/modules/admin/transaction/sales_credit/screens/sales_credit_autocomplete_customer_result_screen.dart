...
class SalesCreditAutoCompleteCustomerResultScreen extends StatelessWidget {
  final SalesCreditController _salesCreditController = Get.put(SalesCreditController());
  final item;
  final query;
  final index;

  SalesCreditAutoCompleteCustomerResultScreen(
    this.item,
    this.query,
    this.index
  );
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        _salesCreditController.setCustomer(item);
        Get.close(null);
      },
    );
  }
