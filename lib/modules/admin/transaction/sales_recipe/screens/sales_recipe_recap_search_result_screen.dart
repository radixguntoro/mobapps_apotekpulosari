...
import 'package:apotik_pulosari/modules/admin/transaction/sales_recipe/screens/sales_recipe_recap_detail_screen.dart';
...
class SalesRecipeRecapSearchResultScreen extends StatelessWidget {
  final data;
  final query;
  final total;
  final index;

  SalesRecipeRecapSearchResultScreen(
    this.data,
    this.query,
    this.total,
    this.index,
