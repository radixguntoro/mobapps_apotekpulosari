...
import 'package:apotik_pulosari/modules/admin/transaction/sales_recipe/screens/sales_recipe_invoice_screen.dart';
import 'package:apotik_pulosari/modules/admin/transaction/sales_recipe/screens/sales_recipe_payment_screen.dart';
import 'package:apotik_pulosari/modules/admin/transaction/sales_recipe/screens/sales_recipe_checkout_item_screen.dart';
...
class SalesRecipeCheckoutListScreen extends StatelessWidget {
                          ...
                          builder: (resp) {
                            return ListView.builder(
                              ...
                              itemBuilder: (context, int i) {
                                return ModelSalesRecipe.medicineRecipe.length > 0 ? SalesRecipeCheckoutItemScreen(ModelSalesRecipe.medicineRecipe[i], i) : Container();
                              },
                            );
                          },
                        ),
                                      ...
                                      Expanded(
                                        ...
                                        child: Container(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((ModelSalesRecipe.total)),
                                                style: TextStyle(
                                                  color: Colors.black,
                                                  fontSize: 14,
                                                  fontWeight: FontWeight.w600
                                      ...
                                      Expanded(
                                        ...
                                        child: Container(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((ModelSalesRecipe.discount)),
                                                style: TextStyle(
                                                  color: Colors.black54,
                                                  fontSize: 14,
                                                  fontWeight: FontWeight.w600
                                      ...
                                      Expanded(
                                        ...
                                        child: Container(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((ModelSalesRecipe.grandTotal)),
                                                style: TextStyle(
                                                  color: Colors.black,
                                                  fontSize: 14,
                                                  fontWeight: FontWeight.w600
                                      ...
                                      Expanded(
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((ModelSalesRecipe.payment)),
                                                style: TextStyle(
                                                  color: Colors.black54,
                                                  fontSize: 14,
                                                  fontWeight: FontWeight.w600
              ...
              child: Container(
                ...
                child: FlatButton(
                  ...
                  onPressed: () async {
                    ...
                    await _salesRecipeController.createData();
                    if (_.result == 'success') {
                      Get.off(SalesRecipeInvoiceScreen(ModelSalesRecipe.getInvoice), transition: Transition.downToUp, duration: Duration(milliseconds: ModelTransition.speed),);
