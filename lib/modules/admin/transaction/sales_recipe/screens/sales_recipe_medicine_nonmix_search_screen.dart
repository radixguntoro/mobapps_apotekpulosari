...
import 'package:apotik_pulosari/modules/admin/transaction/sales_recipe/screens/sales_recipe_medicine_nonmix_search_result_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:mdi/mdi.dart';

class SalesRecipeMedicineNonMixSearchScreen extends SearchDelegate<String> {
    ...
    if(ModelItem.getData.length > 0) {
      return ListView.builder(
        ...
        itemBuilder: (context, int i) {
          return i < ModelItem.getData.length ? SalesRecipeMedicineNonMixSearchResultScreen(ModelItem.getData[i], query, ModelItem.getData.length, i) : Container();
        },
      );
    } else {
