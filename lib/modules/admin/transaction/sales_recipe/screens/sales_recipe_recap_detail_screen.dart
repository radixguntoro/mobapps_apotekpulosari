...
import 'package:apotik_pulosari/modules/admin/transaction/sales_recipe/screens/sales_recipe_recap_item_screen.dart';
...
class SalesRecipeRecapDetailScreen extends StatelessWidget {
  final SalesRecipeController _salesRecipeController = Get.put(SalesRecipeController());
  final data;

  SalesRecipeRecapDetailScreen(
    this.data
  );
  @override
                ...
                children: <Widget>[
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                child: Text(
                                                  TextTransform.title(data['doctor']),
                  ...
                  Container(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        "Total: ${NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((double.parse(data['tr_sales_recipe_medicines'].length.toString())))} barang",
                        style: TextStyle(
                          fontSize: 12
                        ),
                      ),
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: ListView.builder(
                        padding: EdgeInsets.all(0),
                        itemCount: data['tr_sales_recipe_medicines'].length > 0 ? data['tr_sales_recipe_medicines'].length : 0,
                        itemBuilder: (context, int i) {
                          return data['tr_sales_recipe_medicines'].length > 0 ? SalesRecipeRecapItemScreen(data['tr_sales_recipe_medicines'][i], i) : Container();
                        },
                      ),
                    ),
                  ),
      ...
      floatingActionButton: Container(
        ...
        child: FlatButton(
          ...
          onPressed: () async{
            ...
            await _salesRecipeController.readDataById(data['tr_sales_transactions_id']);
