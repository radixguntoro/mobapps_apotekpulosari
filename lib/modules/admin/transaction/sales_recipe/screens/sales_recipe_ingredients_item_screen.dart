...
class SalesRecipeIngredientsItemScreen extends StatelessWidget {
  final SalesRecipeController _salesRecipeController = Get.put(SalesRecipeController());
  final item;
  final index;

  SalesRecipeIngredientsItemScreen(
    this.item,
    this.index,
  );
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: FlatButton(
                                ...
                                onPressed: () {
                                  _salesRecipeController.deleteCart(item['medicines_items_id']);
                                },
                              ),
                            ),
                          ],
                    ...
                    builder: (resp) {
                      return Container(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (val) async{
                            _salesRecipeController.setQtyCart(item, val);
                          },
                        ),
                      );
                    },
