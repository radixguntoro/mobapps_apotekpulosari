...
import 'package:apotik_pulosari/modules/admin/transaction/sales_recipe/screens/sales_recipe_cart_ingredients_item_screen.dart';
...
class SalesRecipeCartIngredientsListScreen extends StatelessWidget {
  final data;
  
  SalesRecipeCartIngredientsListScreen(
    this.data,
  );
  @override
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  child: Text(
                                    data['medicineRecipeName'] != null ? data['medicineRecipeName'].toUpperCase() : 'TANPA NAMA',
                                    style: TextStyle(
                                      fontSize: 16,
                                      color: Colors.white,
                          ...
                          builder: (resp) {
                            return ListView.builder(
                              ...
                              itemBuilder: (context, int i) {
                                return data['details'].length > 0 ? SalesRecipeCartIngredientsItemScreen(data['details'][i], i) : Container();
                              },
                            );
                          },
                        ),
