...
class SalesRecipeMedicineNonMixSearchResultScreen extends StatelessWidget {
  ...
  SalesRecipeMedicineNonMixSearchResultScreen(
    this.item,
    this.query,
    this.total,
    this.index,
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () async {
        _salesRecipeController.createNonMix(item);
        Get.close(null);
      },
    );
  }
