...
import 'package:apotik_pulosari/modules/admin/transaction/purchase/screens/purchase_cart_item_search_screen.dart';
import 'package:apotik_pulosari/modules/admin/transaction/purchase/screens/purchase_cart_item_screen.dart';
import 'package:apotik_pulosari/modules/admin/transaction/purchase/screens/purchase_create_screen.dart';
import 'package:apotik_pulosari/modules/admin/transaction/purchase/screens/purchase_payment_screen.dart';
...
class PurchaseCartListScreen extends StatelessWidget {
  // final PurchaseController _purchaseController = Get.put(PurchaseController());
  // final TextEditingController _inpBarcode = TextEditingController(text: ModelPurchase.barcode);
  
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        Get.off(PurchaseCreateScreen(), transition: Transition.downToUp, duration: Duration(milliseconds: ModelTransition.speed),);
        return true;
      },
      child: Scaffold(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  onTap: () {
                                    ...
                                    showSearch(context: context, delegate: PurchaseCartItemSearchScreen());
                                  },
                                ),
                              ),
                            ),
                            ...
                            if(ModelPurchase.getCart.length > 0) {
                              return ListView.builder(
                                ...
                                itemBuilder: (context, int i) {
                                  return ModelPurchase.getCart.length > 0 ? PurchaseCartItemScreen(ModelPurchase.getCart[i], i) : Container();
                                },
                              );
                            } else {
    ...
    return Container(
      ...
      child: Container(
        ...
        child: FlatButton(
          ...
          onPressed: () async {
            Get.off(PurchasePaymentScreen(), transition: Transition.downToUp, duration: Duration(milliseconds: ModelTransition.speed),);
          },
        ),
      ),
    );
