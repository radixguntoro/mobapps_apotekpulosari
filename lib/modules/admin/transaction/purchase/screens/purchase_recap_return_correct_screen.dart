...
class PurchaseRecapReturnCorrectScreen extends StatelessWidget {
  final PurchaseController _purchaseController = Get.put(PurchaseController());
  final item;
  final data;

  PurchaseRecapReturnCorrectScreen(
    this.item,
    this.data,
  );
  @override
                                    ...
                                    Expanded(
                                      ...
                                      child: Container(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format(ModelPurchase.qtyReturn),
                                              style: TextStyle(
                                    ...
                                    Expanded(
                                      ...
                                      child: Container(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 2).format(ModelPurchase.totalReturn),
                                              style: TextStyle(
                                                color: ColorTheme.danger,
                                                fontSize: 14,
                                                fontWeight: FontWeight.w600
    ...
    return Container(
      ...
      child: Container(
        ...
        child: FlatButton(
          ...
          onPressed: () async {
            _purchaseController.createReturn(data, item);
            Get.close(null);
          },
        ),
      ),
