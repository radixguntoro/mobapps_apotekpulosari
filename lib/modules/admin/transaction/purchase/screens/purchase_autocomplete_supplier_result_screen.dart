...
class PurchaseAutoCompleteSupplierResultScreen extends StatelessWidget {
  ...
  PurchaseAutoCompleteSupplierResultScreen(
    this.item,
    this.query,
    this.index,
    this.state
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        _purchaseController.setSupplier(item, state);
        Get.close(null);
      },
    );
  }
