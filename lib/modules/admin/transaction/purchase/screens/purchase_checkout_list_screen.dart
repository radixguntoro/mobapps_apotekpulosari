...
import 'package:apotik_pulosari/modules/admin/transaction/purchase/screens/purchase_checkout_item_screen.dart';
...
class PurchaseCheckoutListScreen extends StatelessWidget {
                              ...
                              child: Container(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      child: Text(
                                        ModelPurchase.supplierName.toUpperCase(),
                                        style: TextStyle(
                                          fontSize: 14,
                                          color: Colors.white,
                            ...
                            builder: (resp) {
                              return ListView.builder(
                                ...
                                itemBuilder: (context, int index) {
                                  return ModelPurchase.getCart.length > 0 ? PurchaseCheckoutItemScreen(ModelPurchase.getCart[index], index) : Container();
                                },
                              );
                            },
                          ),
                ...
                child: Container(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () async {
                      ...
                      await _purchaseController.createData();
                      if(_.result == 'success') {
                        _purchaseController.readFirst();
                        Get.close(null);
                        ModelPurchase.result = '';
