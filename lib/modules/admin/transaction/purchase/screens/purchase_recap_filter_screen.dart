...
import 'package:apotik_pulosari/modules/admin/transaction/purchase/screens/purchase_autocomplete_supplier_screen.dart';
...
class PurchaseRecapFilterScreen extends StatelessWidget {
        ...
        actions: <Widget>[
          Container(
            ...
            child: FlatButton(
              ...
              onPressed: () async {
                _purchaseController.setResetFilter();
                Get.close(null);
              },
            ),
          ),
                                    ...
                                    Container(
                                      ...
                                      child: FlatButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          _purchaseController.setFilterInvoiceDate(_date);
                                          // Get.close(null);
                                        },
                                      ),
                                    ),
                                      ...
                                      Container(
                                        ...
                                        child: FlatButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            _purchaseController.setFilterPaymentDate(_date);
                                            // Get.close(null);
                                          },
                                        ),
                                      ),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Container(
                                        child: TextFormField(
                                          controller: TextEditingController(text: TextTransform.title(_.supplierName)),
                                          readOnly: true,
                                          ...
                                          onTap: () {
                                            ModelPurchase.getSupplier = [];
                                            showSearch(context: context, delegate: PurchaseAutoCompleteSupplierScreen('recap'));
                                          },
                                        ),
                                      ),
                                    ),
                                          ...
                                          child: GetBuilder(
                                            ...
                                            builder: (_) {
                                              return InkWell(
                                                ...
                                                onTap: () {
                                                  _purchaseController.setFilter(_.filterCredit, 'credit');
                                                },
                                              );
                                            }
                                          ),
                                          ...
                                          child: GetBuilder(
                                            ...
                                            builder: (_) {
                                              return InkWell(
                                                ...
                                                onTap: () {
                                                  _purchaseController.setFilter(_.filterCOD, 'cod');
                                                },
                                              );
                                            }
                                          ),
                                          ...
                                          child: GetBuilder(
                                            ...
                                            builder: (_) {
                                              return InkWell(
                                                ...
                                                onTap: () {
                                                  _purchaseController.setFilter(_.filterConsignment, 'consignment');
                                                },
                                              );
                                            }
                                          ),
            ...
            return Container(
              ...
              child: Container(
                ...
                child: FlatButton(
                  ...
                  onPressed: () async {
                    _purchaseController.setFilterApplyRecap();
                    Get.close(null);
                  },
                ),
              ),
