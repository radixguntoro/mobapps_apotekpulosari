...
import 'package:apotik_pulosari/modules/admin/transaction/purchase/screens/purchase_stock_adjustments_form_screen.dart';
...
class PurchaseStockAdjustmentsItemScreen extends StatelessWidget {
  final item;
  final data;
  final index;

  PurchaseStockAdjustmentsItemScreen(
    this.item,
    this.data,
    this.index,
  );
      ...
      secondaryActions: (ModelAuth.permission != 99 && ModelAuth.permission != 1) || data['status'] == 'paid' ? [] : showBtnReturn == 'show_all' ? [
        ...
        Container(
          ...
          child: FlatButton(
            ...
            onPressed: () async {
              Get.off(PurchaseStockAdjustmentsFormScreen(item, data), transition: Transition.downToUp, duration: Duration(milliseconds: ModelTransition.speed),);
            },
          ),
        ),
      ] : showBtnReturn == 'show_create' ? [
