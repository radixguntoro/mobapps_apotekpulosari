...
import 'package:apotik_pulosari/modules/admin/transaction/purchase/screens/purchase_recap_item_screen.dart';
...
class PurchaseRecapDetailScreen extends StatelessWidget {
  final data;

  PurchaseRecapDetailScreen(
    this.data
  );
  @override
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, int index) {
                          return data['details'].length > 0 ? PurchaseRecapItemScreen(data['details'][index], data, index) : Container();
                        },
                      ),
                    ),
                  ),
