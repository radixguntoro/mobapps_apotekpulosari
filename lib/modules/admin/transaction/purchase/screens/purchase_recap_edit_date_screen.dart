...
class PurchaseRecapEditDateScreen extends StatelessWidget {
  final PurchaseController _purchaseController = Get.put(PurchaseController());
  final data;

  PurchaseRecapEditDateScreen(
    this.data,
  );

  @override
  Widget build(BuildContext context) {
    final DateTime selectedDate = DateTime.parse(data['date']);
    return Scaffold(
          ...
          if (ModelPurchase.isLoading == true) {
            ...
            return Container(
              ...
              child: FlatButton(
                ...
                onPressed: () async{
                  Get.close(null);
                  _purchaseController.updateInvoiceDate();
