...
import 'package:apotik_pulosari/modules/admin/transaction/purchase/screens/purchase_recap_return_detail_item_screen.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:mdi/mdi.dart';
import 'package:get/get.dart';

class PurchaseRecapReturnDetailScreen extends StatelessWidget {
  final PurchaseController _purchaseController = Get.put(PurchaseController());
  final data;
  final item;

  PurchaseRecapReturnDetailScreen(
    this.data,
    this.item,
  );
  @override
                            ...
                            return Container(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, int index) {
                                  return item['return_detail'].length > 0 ? PurchaseRecapReturnDetailItemScreen(item['return_detail'][index], item, index) : Container();
                                },
                              ),
                            );
                          }
