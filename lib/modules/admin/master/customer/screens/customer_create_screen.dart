...
import 'package:apotik_pulosari/modules/admin/master/customer/screens/customer_form_screen.dart';
    ...
    return Container(
      ...
      child: RaisedButton(
        ...
        onPressed: () async {
          ...
          await _customerController.createData();
          if (ModelCustomer.isValidate == false) {
            Get.snackbar(
              "Oops!",
            ...
            if (ModelCustomer.result == 'success') {
              Get.back(result: ModelCustomer.result);
