...
import 'package:apotik_pulosari/modules/admin/master/supplier/screens/supplier_search_result_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:mdi/mdi.dart';

class SupplierSearchScreen extends SearchDelegate<String> {
    ...
    if(ModelSupplier.getData.length > 0) {
      return ListView.builder(
        ...
        itemBuilder: (context, int i) {
          return i < ModelSupplier.getData.length ? SupplierSearchResultScreen(ModelSupplier.getData[i], query, i) : Container();
        }
      );
    } else {
