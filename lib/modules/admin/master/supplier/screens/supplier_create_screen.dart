...
import 'package:apotik_pulosari/modules/admin/master/supplier/screens/supplier_form_screen.dart';
    ...
    return Container(
      ...
      child: FlatButton(
        ...
        onPressed: () async {
          ...
          await _supplierController.createData();
          if (ModelSupplier.isValidate == false) {
            Get.snackbar(
              "Oops!",
            ...
            if (ModelSupplier.result == 'success') {
              Get.back(result: ModelSupplier.result);
