...
import 'package:apotik_pulosari/modules/admin/master/category/screens/category_edit_screen.dart';
...
class CategorySearchResultScreen extends StatelessWidget {
  final String modules = ModelItem.modules;
  final item;
  final query;
  final index;

  CategorySearchResultScreen(
    this.item,
    this.query,
    this.index
  );
        ...
        children: <Widget>[
          ...
          Container(
            child: InkWell(
              ...
              onTap: () async{
                var createData = await Get.to(CategoryEditScreen(), transition: Transition.downToUp, duration: Duration(milliseconds: ModelTransition.speed),);
