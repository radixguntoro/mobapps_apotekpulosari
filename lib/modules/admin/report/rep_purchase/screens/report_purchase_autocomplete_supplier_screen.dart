...
import 'package:apotik_pulosari/modules/admin/report/rep_purchase/screens/report_purchase_autocomplete_supplier_result_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:mdi/mdi.dart';

class ReportPurchaseAutoCompleteSupplierScreen extends SearchDelegate<String> {
    ...
    if(ModelSupplier.getData.length > 0) {
      return ListView.builder(
        ...
        itemBuilder: (context, int i) {
          return i < ModelSupplier.getData.length ? ReportPurchaseAutoCompleteSupplierResultScreen(ModelSupplier.getData[i], query, i) : Container();
        }
      );
    } else {
