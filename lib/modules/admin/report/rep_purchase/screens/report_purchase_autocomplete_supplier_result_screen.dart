...
class ReportPurchaseAutoCompleteSupplierResultScreen extends StatelessWidget {
  final ReportPurchaseController _reportPurchaseController = Get.put(ReportPurchaseController());
  final item;
  final query;
  final index;

  ReportPurchaseAutoCompleteSupplierResultScreen(
    this.item,
    this.query,
    this.index
  );
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        _reportPurchaseController.setSupplier(item);
        Get.close(null);
      },
    );
  }
