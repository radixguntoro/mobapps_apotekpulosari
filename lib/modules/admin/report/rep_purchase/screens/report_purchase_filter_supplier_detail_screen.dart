...
class ReportPurchaseFilterSupplierDetailScreen extends StatelessWidget {
  final ReportPurchaseController _reportPurchaseController = Get.put(ReportPurchaseController());
  final parent;
  final data;

  ReportPurchaseFilterSupplierDetailScreen(
    this.parent,
    this.data,
  );
          ...
          child: Column(
            children: [
              GetBuilder(
                ...
                builder: (_) {
                  ModelReportPurchase.dateStart = ModelReportPurchase.dateStart == null ? DateTime.parse(data['date_start']) : ModelReportPurchase.dateStart;
                  ModelReportPurchase.dateEnd = ModelReportPurchase.dateEnd == null ? DateTime.parse(data['date_end']) : ModelReportPurchase.dateEnd;
                  return Container(
