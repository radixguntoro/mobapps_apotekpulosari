...
import 'package:apotik_pulosari/modules/admin/report/rep_item_card/screens/report_item_card_stockout_data_screen.dart';
...
class ReportItemCardStockOutScreen extends StatelessWidget {
                      ...
                      builder: (resp) { 
                        return Container(
                          ...
                          child: FlatButton(
                            ...
                            onPressed: () {
                              if (ModelReportItemCard.dataItemsOut.length < 1 || resp.isLoading == false) {
                              ...
                              child: GetBuilder(
                                ...
                                builder: (resp) {
                                  if (resp.isLoading == true) {
                                    ...
                                    return Text(
                                      NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format(ModelReportItemCard.qtyItemsOut),
                                      style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 14,
                                        fontWeight: FontWeight.w600,
                              ...
                              child: GetBuilder(
                                ...
                                builder: (resp) {
                                  if (resp.isLoading == true) {
                                    ...
                                    return Text(
                                      NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format(ModelReportItemCard.totalItemsOut),
                                      style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 14,
                                        fontWeight: FontWeight.w600,
                  ...
                  child: GetBuilder(
                    ...
                    builder: (resp) { 
                      if (resp.isLoading == true) {
                        ...
                        if (ModelReportItemCard.dataItemsOut.length > 0) {
                          return SfDataGrid(
                            source: ReportItemCardStockOutDataScreen(ModelReportItemCard.dataItemsOut),
                                  ...
                                  switch (column.mappingName) {
                                    case 'created_at':
                                      return Container(
                                        ...
                                        child: Text(
                                          ModelReportItemCard.dataItemsOut[rowIndex]['created_at'].toString(),
                                          style: TextStyle(
                                            fontSize: 12
                                          ),
                                        )
                                    ...
                                    case 'id':
                                      return Container(
                                        ...
                                        child: Text(
                                          ModelReportItemCard.dataItemsOut[rowIndex]['id'].toString(),
                                          style: TextStyle(
                                            fontSize: 12
                                          ),
                                        )
                                    ...
                                    case 'name':
                                      return Container(
                                        ...
                                        child: Text(
                                          ModelReportItemCard.dataItemsOut[rowIndex]['name'],
                                    ...
                                    case 'category':
                                      return Container(
                                        ...
                                        child: Text(
                                          ModelReportItemCard.dataItemsOut[rowIndex]['category'],
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                            fontSize: 12,
                                          ),
                                    ...
                                    case 'note':
                                      return Container(
                                        ...
                                        child: Text(
                                          TextTransform.title(ModelReportItemCard.dataItemsOut[rowIndex]['note']),
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                            fontSize: 12,
                                    ...
                                    case 'cashier_name':
                                      return Container(
                                        ...
                                        child: Text(
                                          TextTransform.title(ModelReportItemCard.dataItemsOut[rowIndex]['cashier_name']),
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                            fontSize: 12,
                                          ),
                                    ...
                                    case 'qty':
                                      return Container(
                                        ...
                                        child: Text(
                                          NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((int.parse(ModelReportItemCard.dataItemsOut[rowIndex]['qty'].toString())))
                                          ,
                                    ...
                                    case 'price':
                                      return Container(
                                        ...
                                        child: Text(
                                          NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((double.parse(ModelReportItemCard.dataItemsOut[rowIndex]['price'].toString())))
                                          ,
                                          textAlign: TextAlign.end,
                                          style: TextStyle(
                                            fontSize: 12
                                    ...
                                    case 'subtotal':
                                      return Container(
                                        ...
                                        child: Text(
                                          NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format((double.parse(ModelReportItemCard.dataItemsOut[rowIndex]['subtotal'].toString())))
                                          ,
                                          textAlign: TextAlign.end,
                                          style: TextStyle(
                                            fontSize: 12
