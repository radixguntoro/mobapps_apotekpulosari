...
class ReportItemCardAutoCompleteItemSearchResultScreen extends StatelessWidget {
  ...
  ReportItemCardAutoCompleteItemSearchResultScreen(
    this.item,
    this.query,
    this.total,
    this.index,
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        _reportItemCardController.setItem(item);
        Get.close(null);
      },
    );
  }
