...
class ReportItemCardExportXLSStockOutController extends GetxController {
  void exportToExcel() async {
    ...
    final File file = File('$path/APS-REKAP-BARANG-KELUAR-${DateFormat('dd-MM-yyyy', 'id_ID').format(ModelReportItemCard.dateStart).toString()}.xlsx');
    await file.writeAsBytes(bytes);

    //Launch the file (used open_file package)
    await open_file.OpenFile.open('$path/APS-REKAP-BARANG-KELUAR-${DateFormat('dd-MM-yyyy', 'id_ID').format(ModelReportItemCard.dateStart).toString()}.xlsx');
