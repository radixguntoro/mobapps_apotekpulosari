...
class ReportSalesFilterRecapListScreen extends StatelessWidget {
  final ReportSalesController _reportSalesController = Get.put(ReportSalesController());
  final data;

  ReportSalesFilterRecapListScreen(
    this.data
  );
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      builder: (_) {
        ModelReportSales.dateStart = ModelReportSales.dateStart == null ? DateTime.parse(data['date_start'].toString()) : ModelReportSales.dateStart;
        ModelReportSales.dateEnd = ModelReportSales.dateEnd == null ? DateTime.parse(data['date_end'].toString()) : ModelReportSales.dateEnd;
        return Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        RichText(
                          text: TextSpan(
                            children: [
                              for (var item in ModelReportSales.getSalesType)
                                WidgetSpan(
                                  child: GetBuilder(
                                    init: ReportSalesController(),
                                    builder: (_) {
