...
class ReportSalesAutoCompleteCustomerResultScreen extends StatelessWidget {
  final ReportSalesController _reportSalesController = Get.put(ReportSalesController());
  final item;
  final query;
  final index;

  ReportSalesAutoCompleteCustomerResultScreen(
    this.item,
    this.query,
    this.index
  );
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        _reportSalesController.setCustomer(item);
        Get.close(null);
      },
    );
  }
