...
class ReportSalesFilterCustomerDetailScreen extends StatelessWidget {
  final ReportSalesController _reportSalesController = Get.put(ReportSalesController());
  final data;

  ReportSalesFilterCustomerDetailScreen(
    this.data
  );
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      builder: (_) {
        ModelReportSales.dateStart = ModelReportSales.dateStart == null ? DateTime.parse(data['date_start']) : ModelReportSales.dateStart;
        ModelReportSales.dateEnd = ModelReportSales.dateEnd == null ? DateTime.parse(data['date_end']) : ModelReportSales.dateEnd;
        return Expanded(
