...
import 'package:apotik_pulosari/modules/admin/report/rep_sales/screens/report_sales_filter_netto_screen.dart';
import 'package:apotik_pulosari/modules/admin/report/rep_sales/screens/report_sales_netto_list_data_screen.dart';
...
class ReportSalesNettoListScreen extends StatelessWidget {
                                          ...
                                          child: Row(
                                            children: [
                                              Expanded(
                                                child: Container(
                                                  child: Text(
                                                    ModelReportSales.customerPersonsName == '' ? "SEMUA PELANGGAN" : ModelReportSales.customerPersonsName,
                                                    style: TextStyle(
                                                      color: Colors.white,
                                                      fontSize: 10
                                                    ),
                      ...
                      builder: (_) {
                        return Container(
                          ...
                          child: FlatButton(
                            ...
                            onPressed: () {
                              Get.to(ReportSalesFilterNettoScreen(), transition: Transition.downToUp, duration: Duration(milliseconds: ModelTransition.speed),);
                            },
                          )
                        );
                      }
                    ...
                    builder: (resp) {
                      if (ModelReportSales.isLoading == true) {
                        ...
                        if(ModelReportSales.getData.length > 0){
                          return SfDataGrid(
                            source: ReportSalesNettoListDataScreen(ModelReportSales.getData),
                                  ...
                                  switch (column.mappingName) {
                                    ...
                                    case 'customer_name':
                                      return Container(
                                        ...
                                        child: Text(
                                          ModelReportSales.getData[rowIndex]['customer_name'],
                                          style: TextStyle(
                                            fontSize: 12
                                          ),
                                        )
                                    ...
                                    case 'status':
                                      return Container(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text(
                                            ModelReportSales.getData[rowIndex]['status'],
                                          ...
                                          decoration: BoxDecoration(
                                            color:  ModelReportSales.getData[rowIndex]['status_id'] == 'credit' ? ColorTheme.danger :  ModelReportSales.getData[rowIndex]['status_id'] == 'cod' ? ColorTheme.warningColor :  ModelReportSales.getData[rowIndex]['status_id'] == 'consignment' ? Colors.blue : ColorTheme.successColor,
