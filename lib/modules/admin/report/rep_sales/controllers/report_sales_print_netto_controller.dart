...
class ReportSalesPrintNettoController extends GetxController {
  ...
  PdfGrid getGridBody() {
    ...
    footer1.cells[3].value = '${NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 2).format(double.parse(ModelReportSales.getDataDetail['total'].toString()))}';
    ...
    footer2.cells[3].value = '${NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 2).format(double.parse(ModelReportSales.getDataDetail['discount'].toString()))}';
    ...
    footer3.cells[3].value = '${NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 2).format(double.parse(ModelReportSales.getDataDetail['grandTotal'].toString()))}';
