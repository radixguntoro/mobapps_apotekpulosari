...
class ReportSalesExportXlsRecapListController extends GetxController {
  void exportToExcel() async {
    ...
    sheet.getRangeByIndex(12, 4).setText('TIPE');
    sheet.getRangeByIndex(12, 5).setText('KASIR');
    sheet.getRangeByIndex(12, 6).setText('GRAND TOTAL');
