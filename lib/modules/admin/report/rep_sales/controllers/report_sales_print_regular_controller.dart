...
class ReportSalesPrintRegularController extends GetxController {
  ...
  PdfGrid getGridHeader() {
    ...
    headerRow.cells[2].value = '${ModelReportSales.getDataDetail['createdAt']}';
    ...
    headerRow1.cells[1].value = '${TextTransform.title(ModelReportSales.getDataDetail['userName'])}';
    ...
    headerRow1.cells[2].value = '${ModelReportSales.getDataDetail['timeAt']}';
