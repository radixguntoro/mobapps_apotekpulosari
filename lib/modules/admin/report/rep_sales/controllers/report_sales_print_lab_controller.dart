...
class ReportSalesPrintLabController extends GetxController {
  ...
  void drawGrid(PdfPage page, PdfGrid gridHeader, PdfGrid gridBody, PdfLayoutResult result, Size pageSize) {
    ...
    page.graphics.drawRectangle(
      ...
      bounds: Rect.fromLTWH(0, 162, pageSize.width, 4)
    );
    //Draw rectangle
    page.graphics.drawRectangle(
      brush: PdfSolidBrush(PdfColor(0, 0, 0, 1)),
      bounds: Rect.fromLTWH(0, 168, pageSize.width, 1)
    );
    //Draw the grid Body
    gridBody.draw(page: page, bounds: const Rect.fromLTWH(0, 176, 0, 0));
  }
  ...
  PdfGrid getGridHeader() {
    ...
    final PdfGridRow headerRow2 = grid.headers.add(1)[2];
    //Set style
    headerRow2.cells[0].value = '';
    headerRow2.cells[0].style.borders = PdfBorders(
      left: PdfPens.white,
      top: PdfPens.black,
      bottom: PdfPens.white,
      right: PdfPens.white
    );
    headerRow2.cells[1].value = '';
    headerRow2.cells[1].stringFormat.alignment = PdfTextAlignment.center;
    headerRow2.cells[1].style.borders = PdfBorders(
      left: PdfPens.white,
      top: PdfPens.black,
      bottom: PdfPens.white,
      right: PdfPens.white
    );
    headerRow2.cells[2].value = '';
    headerRow2.cells[2].stringFormat.alignment = PdfTextAlignment.right;
    headerRow2.cells[2].style.borders = PdfBorders(
      left: PdfPens.white,
      top: PdfPens.black,
      bottom: PdfPens.white,
      right: PdfPens.white
    ...
    final PdfGridRow headerRow3 = grid.headers.add(1)[3];
    //Set style
    headerRow3.cells[0].value = 'Pasien';
    headerRow3.cells[0].style.borders = PdfBorders(
      left: PdfPens.white,
      top: PdfPens.white,
      bottom: PdfPens.white,
      right: PdfPens.white
    );
    headerRow3.cells[1].value = '';
    headerRow3.cells[1].stringFormat.alignment = PdfTextAlignment.center;
    headerRow3.cells[1].style.borders = PdfBorders(
      left: PdfPens.white,
      top: PdfPens.white,
      bottom: PdfPens.white,
      right: PdfPens.white
    );
    headerRow3.cells[2].value = 'Umur';
    headerRow3.cells[2].stringFormat.alignment = PdfTextAlignment.right;
    headerRow3.cells[2].style.borders = PdfBorders(
      left: PdfPens.white,
      top: PdfPens.white,
      bottom: PdfPens.white,
      right: PdfPens.white
    );
    final PdfGridRow headerRow4 = grid.headers.add(1)[4];
    //Set style
    headerRow4.cells[0].value = '${ModelReportSales.getDataDetail['patient']}';
    headerRow4.cells[0].style.borders = PdfBorders(
      left: PdfPens.white,
      top: PdfPens.white,
      bottom: PdfPens.white,
      right: PdfPens.white
    );
    headerRow4.cells[1].value = '';
    headerRow4.cells[1].stringFormat.alignment = PdfTextAlignment.center;
    headerRow4.cells[1].style.borders = PdfBorders(
      left: PdfPens.white,
      top: PdfPens.white,
      bottom: PdfPens.white,
      right: PdfPens.white
    );
    headerRow4.cells[2].value = '${ModelReportSales.getDataDetail['age']}';
    headerRow4.cells[2].stringFormat.alignment = PdfTextAlignment.right;
    headerRow4.cells[2].style.borders = PdfBorders(
      left: PdfPens.white,
      top: PdfPens.white,
      bottom: PdfPens.white,
      right: PdfPens.white
